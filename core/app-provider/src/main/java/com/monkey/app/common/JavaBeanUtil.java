...
import com.monkey.app.entity.GeoBean;
...
public class JavaBeanUtil {
    ...
    public Map<Object, Object> sortMapByValue(Map<Object, Object> oriMap) {
        ...
        List<Entry<Object, Object>> entryList = new ArrayList<Entry<Object, Object>>(oriMap.entrySet());

        Collections.sort(entryList, new MapValueComparator());

        Iterator<Entry<Object, Object>> iter = entryList.iterator();
    ...
    public class MapValueComparator implements Comparator<Entry<Object, Object>> {
        @Override
